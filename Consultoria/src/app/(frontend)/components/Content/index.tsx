    ...
    return(
        ...
        textAlign:'center'
            ...
            <Box sx={{backgroundColor:'#daf3e0ff', borderRadius:2,}}>
                <Typography sx={{paddingY:0.5,margin:2 ,fontSize:12, color:'#016630', fontWeight:600}}>
                Nossos Serviços
                </Typography>
            </Box>
            <Box sx={{marginBottom:8}}> 
                <Typography sx={{fontSize:36, fontWeight:'bold', marginBottom:2}}>Especialização em Três Culturas Estratégicas</Typography>
                <Typography sx={{color:'#575757ff',paddingX:35}}>Nossa expertise abrange as principais commodities do agronegócio brasileiro, oferecendo soluções personalizadas para cada cultura.</Typography>
            </Box>
            <Box sx={{
                display:'grid',
                ...
                <Card sx={{borderRadius:4}}>
                    <CardMedia  sx={{'&:hover':{scale:1.2, transition:'0.2s'}, transition:'0.2s'}}
                    component='img'
                    ...
                    <CardContent>
                        ...
                        <Box><Typography>Aumento médio de 25% na produtividade</Typography></Box>
...
<Box>
                        ...
                        <Box><Typography>Redução de 40% nos custos de produção</Typography></Box>
                        <Button>Saiba Mais</Button>
                    </CardContent>
                </Card>
                <Card sx={{borderRadius:4}}>
                    <CardMedia sx={{'&:hover':{scale:1.2, transition:'0.2s'}, transition:'0.2s'}} component='img'
...
<Box>
                        ...
                        <Box><Typography>35% maior resistência à estiagem</Typography></Box>
                        <Button>Saiba Mais</Button>
                    </CardContent>
                </Card>
